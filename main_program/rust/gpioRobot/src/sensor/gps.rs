...
impl GPSmodule<'_> {
    ...
    pub fn nav(
        &mut self,
        now_postion: (f64, f64),
    ) -> (bool, (f64, f64), (f64, f64), bool, &mut Vec<(f64, f64)>) {
        ...
        let result: (bool, (f64, f64), (f64, f64), bool, &mut Vec<(f64, f64)>) =
            match self.latlot.len() {
                0 => (true, (azimuth, distance), (0.0, 0.0), false, self.latlot),
                1.. => {
                    //println!("{:?}", self.latlot);
                    ...
                    if flag {
                        ...
                        (false, (azimuth, distance), diff, flag, self.latlot)
                    } else {
                        (false, (azimuth, distance), diff, false, self.latlot)
                    }
                }
                _ => (false, (azimuth, distance), (0.0, 0.0), false, self.latlot),
            };
